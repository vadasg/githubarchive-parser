...
To start loading, first review the options in ImportGitHubArchive.groovy then do

```bash
gremlin -e ImportGitHubArchive.groovy
```

Loading all of the data from the start of the archive in 2012-03 through the end of 2012-09 took me about 9 hours on a single desktop machine.  When it is finished you should see a summary like this:
